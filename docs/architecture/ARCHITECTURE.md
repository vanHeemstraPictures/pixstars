...
| MEAN WELL LRS-50-12 | Opt Lasers 300mW Micro RGB laser module (via LPLDD-1A-16V-3CH driver) | Cave harness | DC 12V via dedicated laser PSU | Powers the Opt Lasers 300mW Micro RGB module in the lamp head via the LPLDD driver and the 0-5V RGB modulation lines through the cable column |
